...
A prestação de serviços de saúde enfrenta desafios estruturais, como a limitação de infraestrutura de rede, especialmente crítica para médicos rurais, e o aprisionamento de dados por sistemas proprietários. O presente projeto atua nesses problemas ao propor um Prontuário Eletrônico do Paciente (PEP) modular e de código livre (open-source), focado em democratizar a gestão médica.
